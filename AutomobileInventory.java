...
public class AutomobileInventory {
    ...
    private final static String FILENAME =
            "C:/Users/Jeffc/OneDrive/Desktop/CSC320/Module8";
    static String answer;
    static boolean YN;
    public AutomobileInventory() {
        vehicleList = new ArrayList<>();
    }
    public AutomobileInventory(String make, String model, String color, int year, int
            mileage) {
        this.make = make;
        this.model = model;
        this.color = color;
    ...
    //update
    public void updateVehicle(String makeOld, String modelOld, String colorOld, int yearOld,
                              int
